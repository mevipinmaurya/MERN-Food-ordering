...
const FoodItemDisplay = ({ foodItem }) => {
    const { foodList, addToCart } = useContext(FoodContext)
            ...
            <div className='w-[90%]'>
                <div className='flex flex-col justify-center'>
                    <div className='flex flex-wrap gap-4'>
                        <img src={`http://localhost:3000/images/` + foodItem.image} alt="" className='w-[520px] hover:scale-105 rounded-md' />
                        <div className='flex flex-col gap-4'>
                            <img src={`http://localhost:3000/images/` + foodItem.image} alt="" className='w-[250px] hover:scale-105 rounded-md' />
                            <img src={`http://localhost:3000/images/` + foodItem.image} alt="" className='w-[250px] hover:scale-105 rounded-md' />
                        </div>
                        <div className='flex flex-col gap-4'>
                            <img src={`http://localhost:3000/images/` + foodItem.image} alt="" className='w-[250px] hover:scale-105 rounded-md' />
                    ...
                    <div className='w-full flex-col flex mt-10'>
                        ...
                        <div className='flex flex-col mt-7'>
                            ...
                            <button onClick={() => addToCart(foodItem._id)} className="btn bg-orange-600 hover:bg-orange-700 text-white text-lg mt-7 w-[160px]">Add To Cart</button>
                        </div>
                    </div>
                </div>
