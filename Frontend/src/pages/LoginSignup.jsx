...
const LoginSignup = () => {
  ...
  const [fromState, setFormState] = useState('Login');

  return (
    <>
      <div className='w-full flex justify-center items-center mb-20'>
        <div className='w-[80%] p-8 md:w-[50%] md:p-10 lg:w-[40%] lg:p-14 border-[1px] rounded-lg mt-7 '>
          <h1 className='text-xl md:text-3xl font-semibold mb-8'>{fromState}</h1>
          <div className='flex flex-col gap-5'>
            ...
            <button className='btn bg-orange-600 inline font-semibold text-white text-xl hover:bg-orange-700'>{fromState}</button>
            {fromState === "Login"
